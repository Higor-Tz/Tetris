...
public class Indiv
{
    ...
    Indiv()
    {
        this.weightRotate1 = new double[numPieces + surfaceSize];
        // this.weightRotate2 = new double[this.numPieces];
        // this.weightRotate3 = new double[this.numPieces];
        this.weightMoveR1 = new double[numPieces + surfaceSize];
